...
class WPvivid_Restore_addon
{
    ...
    public function init_page()
    {
        ...
        <script>
            ...
            jQuery('#wpvivid_restore_prev_step_1').click(function()
            {
            ...
            jQuery('#wpvivid_restore_now').click(function()
            {
            ...
            jQuery('#wpvivid_restore_version_selector').on("click",'.first-page',function()
            {
                wpvivid_restore_version_change_page('first');
            });

            jQuery('#wpvivid_restore_version_selector').on("click",'.prev-page',function()
            {
                var page=parseInt(jQuery(this).attr('value'));
                wpvivid_restore_version_change_page(page-1);
            });

            jQuery('#wpvivid_restore_version_selector').on("click",'.next-page',function()
            {
                var page=parseInt(jQuery(this).attr('value'));
                wpvivid_restore_version_change_page(page+1);
            });

            jQuery('#wpvivid_restore_version_selector').on("click",'.last-page',function()
            {
    ...
    public function show_backup_detail()
    {
        ...
        <div style="padding:0 1em 1em 1em;background:#eaf1fe;">
            ...
            <div id="wpvivid_restore_setting" style="display: none">
                ...
                <?php
                if(isset($this->backup_data['has_core']))
                {
                    ?>
                    <p></p>
                    <div>
                ...
                <?php
                if(isset($this->backup_data['has_db']))
                {
                    ?>
                    <p></p>
                    <div>
                    ...
                    <?php
                    //if(isset($this->backup_data['is_db_crypt']))
                    {
                        $general_setting=WPvivid_Setting::get_setting(true, "");
                ...
                ?>
                <!--<p><input type="checkbox" option="restore_detail_options" name="create_snapshot" checked> Create a snapshot before restoring. This will keep your website away from crashing if the restore fails. Need more database space.</p>-->
            </div>
        </div>
