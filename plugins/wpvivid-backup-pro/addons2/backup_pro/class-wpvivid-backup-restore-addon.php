...
class WPvivid_New_BackupList
{
    ...
    public function __construct()
    {
        if( apply_filters('wpvivid_current_user_can',true,'wpvivid-can-mange-remote-backup'))
        {
            $this->backup_list['remote'] = get_option('wpvivid_new_remote_list',array());
        }
        else
        {
            $this->backup_list['remote'] = array();
        }

        if( apply_filters('wpvivid_current_user_can',true,'wpvivid-can-mange-local-backup'))
        {
            $this->backup_list['local'] = get_option('wpvivid_backup_list',array());
        }
        else
        {
            $this->backup_list['local'] = array();
        }
    }
