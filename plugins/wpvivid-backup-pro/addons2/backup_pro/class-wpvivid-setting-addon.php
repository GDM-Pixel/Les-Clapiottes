...
class WPvivid_Setting_addon
{
    ...
    public function output_manual_backup_count_setting_page()
    {
        ...
        if(isset($options['max_remote_backup_count']))
        ...
        if(isset($options['max_remote_backup_db_count']))
        ...
        <div>
            <div>
                ...
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="max_remote_backup_count" id="manual_max_remote_backup_count" value="<?php esc_attr_e($max_remote_backup_count); ?>" onkeyup="wpvivid_set_max_remote_backup_count(this);"> (remote storage)File Backups retained.</p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="max_remote_backup_db_count" id="manual_max_remote_backup_db_count" value="<?php esc_attr_e($max_remote_backup_db_count); ?>" onkeyup="wpvivid_set_max_remote_backup_db_count(this);"> (remote storage)Database backups retained.</p>
            </div>
        </div>
        <?php
    }
    ...
    public function output_schedule_backup_count_setting_page()
    {
        ...
        <div>
            <div>
                ...
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" id="schedule_max_remote_backup_count" value="<?php esc_attr_e($max_remote_backup_count); ?>" onkeyup="wpvivid_set_max_remote_backup_count(this);"> (remote storage)File Backups retained.</p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" id="schedule_max_remote_backup_db_count" value="<?php esc_attr_e($max_remote_backup_db_count); ?>" onkeyup="wpvivid_set_max_remote_backup_db_count(this);"> (remote storage)Database backups retained.</p>
            </div>
        </div>
        <?php
    }
