                            ...
                            <div class="row col-12 m-0 p-0">
                                <div class="col-5 p-0 m-0">
                                    <select name="sq_bulk_action" class="sq_bulk_action">
                                        ...
                                        <option value="sq_ajax_briefcase_bulk_delete" data-confirm="<?php echo esc_html__("Are you sure you want to delete the keywords?", 'squirrly-seo') ?>"><?php echo esc_html__("Delete") ?></option>
                                    </select>
