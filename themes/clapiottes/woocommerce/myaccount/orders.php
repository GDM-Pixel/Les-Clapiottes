...
<?php else : ?>
	...
	<?php wc_print_notice('<p>' . esc_html__('No order has been made yet.', 'woocommerce') . '</p>' . ' <a class="woocommerce-Button button' . esc_attr($wp_button_class) . '" href="/">' . esc_html__('Browse products', 'woocommerce') . '</a>', 'notice'); // phpcs:ignore WooCommerce.Commenting.CommentHooks.MissingHookComment 
	?>
