    ...
    <main <?php generate_do_attr('main'); ?>>
		...
		if (generate_has_default_loop()) {
			if (have_posts()) :
				...
				echo '<div class="blogintro"><h1 class="withb">Les recettes des Clapiottes</h1>
				<p>Retrouvez ici toutes les recettes des Clapiottes : certaines sont déjà sur nos plateaux, d\'autres sont à tester chez vous !</p></div>
				';
				wpgb_render_grid(
					[
						'id' => 3, // Grid id.
